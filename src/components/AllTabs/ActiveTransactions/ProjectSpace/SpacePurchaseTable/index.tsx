...
const PurchaseTable = () => {
    ...
    const headers = ['Version', 'Version Type', 'Date Uploaded', 'Document', 'Relevant Support'];
    const [data, setData] = useState([
        ['Project Space SPA V1', 'Autogenerated', '3/02/2024 at 5:00PM', '/icons/pdficon.svg', '/icons/wordfile.svg', 'EsquireAI prompt'],
        ['Project Space SPA V2', 'From Counsel', '3/06/2024 at 6:00PM', '/icons/pdficon.svg', '/icons/wordfile.svg', 'Email with Sage Capital Comments', 'Redline'],
        ['Project Space SPA V3', 'Sent Externally', '3/08/2024 at 8:00PM', '/icons/pdficon.svg', '/icons/wordfile.svg', 'NWC Math for PEG', 'Redline'],
    ...
    useEffect(() => {
        if (showColumn) {
            setData(prevData => [...prevData, ['Project Space SPA V4', 'External Counter', '3/15/2024 at 9:00PM', '/icons/pdficon.svg', '/icons/wordfile.svg', 'Indebtedness Calc', 'Redline']]);
        } else {
            setData(prevData => prevData.slice(0, 3));
        }
    }, [showColumn]);
        ...
        <div className='w-full flex flex-col gap-4'>
            ...
            </div>
            {
                ...
                <div className='flex items-end relative'>
                    ...
                    <button onClick={() => setShowColumn(!showColumn)} className='ml-2 absolute opacity-5 top-[160px] -right-7'>
